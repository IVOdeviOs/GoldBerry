...
struct DisclaimerOfLiabilityView: View {
    var body: some View {
        ScrollView(.vertical, showsIndicators: false) {
            VStack {
                Text("Политика конфиденциальности\nперсональных данных")
                    ...
                    .padding()
                Text("""
                     Настоящее Положение о конфиденциальности персональных данных (далее – Положение) разработано ООО «ФЛАВЕРИ.РУ» в лице Генерального директора Чистобородова Кирилла Павловича, действующего на основании Устава и содержит в себе базовые нормы обработки, хранения и передачи персональных данных пользователей в рамках Интернет Сервиса flawery.ru.
                     Настоящее Положение о конфиденциальности персональных данных разработано в строгом соответствии с Федеральным Законом Российской Федерации № 152-ФЗ «О персональных данных», а также другими нормативно-правовыми документами, которые регулируют порядок обработки персональных данных пользователей, в том числе в сети Интернет посредством Интернет Сервиса.
                     1. ТЕРМИНЫ И ОПРЕДЕЛЕНИЯ
                     В рамках настоящего Положения термины и определения используются в следующем значение:
                     1.1. Интернет Сервис - совокупность программных и аппаратных средств для ЭВМ, обеспечивающих публикацию для всеобщего обозрения информации и данных, объединенных общим целевым назначением, посредством технических средств, применяемых для связи между ЭВМ в сети Интернет. Сервис доступен Пользователям по уникальному электронному адресу или его буквенному обозначению. Под Сервисом в настоящем Положении понимается Интернет Сервис, расположенный в сети Интернет по адресу – flawery.ru.
                     ...
                     2.9. Пользователь несет персональную ответственность за проверку настоящего Положения на наличие изменений в нем. Администрация Сервиса оставляет за собой право по своему личному усмотрению изменять или дополнять настоящее Положение в любое время без предварительного и последующего уведомления. Администрация Сервиса будет публиковать такие изменения и/или дополнения по адресу flawery.ru. Дальнейшее использование Пользователем Сервиса, после любых подобных изменений, означает полное согласие такого Пользователя с такими изменениями и дополнениями.
                     ...
                     Расчётный счёт: 40702810401910001023
                     Юридический адрес: 109316, г. Москва, Волгоградский проспект, строение 43, корпус 3, офис 1529
                     Фактический адрес: 109316, г. Москва, Волгоградский проспект, строение 43, корпус 3, офис 1529
...
struct DisclaimerOfLiabilityView_Previews: PreviewProvider {
